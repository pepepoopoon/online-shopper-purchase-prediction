"""Model candidates and classification metrics."""
...
def select_for_budget(scores: np.ndarray, budget_fraction: float) -> np.ndarray:
    """Выбрать ровно ceil(n * budget_fraction) строк с максимальными score."""
...
def classification_metrics(
    ...
    matrix = confusion_matrix(truth, labels, labels=[0, 1])
    return {
